...
export const en: Dict = {
  ...
  demo: {
    ...
    paso0: { titulo: "Take a seat", texto: "Tap “Join” below and put your name in. Bea, Nacho and Sofía are already here." },
    paso1: { titulo: "Mark what you had", texto: "Tap a dish and hit “Mine”. The octopus and some beers are still free." },
  ...
  comanda: {
    ...
    teHanPagadoVarios: "{n} say they paid you",
    verCuentas: "See the accounts",
  ...
  cobro: {
    ...
    movil: "Mobile",
    bizumSimulado: "This is what a real Bizum looks like: you copy these three details into your bank. The number is made up.",
    simulacion: "Simulation",
    simulacionAviso: "It's a simulation: nothing is charged and you stay in the app.",
    titular: "Made-up holder",
    paraQuien: "To",
    pagarSimulado: "Pay {dinero} (pretend)",
    concepto: "Reference",
    importe: "Amount",
    copiar: "Copy",
    copiado: "Copied ✓",
