...
export const es = {
  ...
  demo: {
    ...
    paso0: { titulo: "Siéntate a la mesa", texto: "Pulsa «Unirme» ahí abajo y ponte un nombre. Bea, Nacho y Sofía ya están." },
    paso1: { titulo: "Marca lo que te has tomado", texto: "Toca un plato y pulsa «Es mío». Queda el pulpo y unas cañas libres." },
  ...
  comanda: {
    ...
    teHanPagadoVarios: "{n} dicen que te han pagado",
    verCuentas: "Ver las cuentas",
  ...
  cobro: {
    ...
    movil: "Móvil",
    bizumSimulado: "Así se ve un Bizum de verdad: estos tres datos se copian y se pegan en tu banco. El móvil es inventado.",
    simulacion: "Simulación",
    simulacionAviso: "Es una simulación: no se cobra nada ni se sale de la app.",
    titular: "Titular de mentira",
    paraQuien: "Para",
    pagarSimulado: "Pagar {dinero} (de mentira)",
    concepto: "Concepto",
    importe: "Importe",
    copiar: "Copiar",
    copiado: "Copiado ✓",
